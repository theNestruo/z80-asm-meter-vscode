...
class GlassFakeInstructionParserRef extends OptionalSingletonRefImpl<InstructionParser, GlassFakeInstructionParser> {
...
class GlassFakeInstructionParser implements InstructionParser {
	...
	parseInstruction(s: SourceCode): Meterable | undefined {
		...
		return z80InstructionParser.instance.parseRawInstruction(equivalentInstruction);
	}
