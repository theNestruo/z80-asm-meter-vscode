...
export const z80InstructionSetRawData = [
    [ "ADC A,(HL)", "7", "8", "2", "8E", "1" ],
	[ "ADC A,(IX)", "19", "21", "3", "DD 8E o", "3" ],
	[ "ADC A,(IX+o)", "19", "21", "3", "DD 8E o", "3" ],
	[ "ADC A,(IY)", "19", "21", "3", "FD 8E o", "3" ],
	...
	[ "ADD A,(HL)", "7", "8", "2", "86", "1" ],
	[ "ADD A,(IX)", "19", "21", "3", "DD 86 o", "3" ],
	[ "ADD A,(IX+o)", "19", "21", "3", "DD 86 o", "3" ],
	[ "ADD A,(IY)", "19", "21", "3", "FD 86 o", "3" ],
	...
	[ "AND (HL)", "7", "8", "2", "A6", "1" ],
	[ "AND (IX)", "19", "21", "3", "DD A6 o", "3" ],
	[ "AND (IX+o)", "19", "21", "3", "DD A6 o", "3" ],
	[ "AND (IY)", "19", "21", "3", "FD A6 o", "3" ],
	...
	[ "BIT b,(IX)", "20", "22", "6", "DD CB o 46+8*b", "4" ],
	[ "BIT b,(IX+o)", "20", "22", "6", "DD CB o 46+8*b", "4" ],
	[ "BIT b,(IY)", "20", "22", "6", "FD CB o 46+8*b", "4" ],
	...
	[ "CCF", "4", "5", "1", "3 F", "1" ],
	[ "CP (HL)", "7", "8", "2", "BE", "1" ],
	[ "CP (IX)", "19", "21", "3", "DD BE o", "3" ],
	[ "CP (IX+o)", "19", "21", "3", "DD BE o", "3" ],
	[ "CP (IY)", "19", "21", "3", "FD BE o", "3" ],
	...
	[ "DAA", "4", "5", "1", "27", "1" ],
	[ "DEC (HL)", "11", "12", "3", "35", "1" ],
	[ "DEC (IX)", "23", "25", "6", "DD 35 o", "3" ],
	[ "DEC (IX+o)", "23", "25", "6", "DD 35 o", "3" ],
	[ "DEC (IY)", "23", "25", "6", "FD 35 o", "3" ],
	...
	[ "INC (HL)", "11", "12", "3", "34", "1" ],
	[ "INC (IX)", "23", "25", "6", "DD 34 o", "3" ],
	[ "INC (IX+o)", "23", "25", "6", "DD 34 o", "3" ],
	[ "INC (IY)", "23", "25", "6", "FD 34 o", "3" ],
	...
	[ "LD (IX),n", "19", "21", "6", "DD 36 o n", "4" ],
	[ "LD (IX+o),n", "19", "21", "6", "DD 36 o n", "4" ],
	[ "LD (IX),r", "19", "21", "5", "DD 70+r o", "3" ],
	[ "LD (IX+o),r", "19", "21", "5", "DD 70+r o", "3" ],
	[ "LD (IY),n", "19", "21", "6", "FD 36 o n", "4" ],
	[ "LD (IY+o),n", "19", "21", "6", "FD 36 o n", "4" ],
	[ "LD (IY),r", "19", "21", "5", "FD 70+r o", "3" ],
	...
	[ "LD A,(DE)", "7", "8", "2", "1A", "1" ],
	[ "LD A,(HL)", "7", "8", "2", "7E", "1" ],
	[ "LD A,(IX)", "19", "21", "5", "DD 7E o", "3" ],
	[ "LD A,(IX+o)", "19", "21", "5", "DD 7E o", "3" ],
	[ "LD A,(IY)", "19", "21", "5", "FD 7E o", "3" ],
	...
	[ "LD B,(HL)", "7", "8", "2", "46", "1" ],
	[ "LD B,(IX)", "19", "21", "5", "DD 46 o", "3" ],
	[ "LD B,(IX+o)", "19", "21", "5", "DD 46 o", "3" ],
	[ "LD B,(IY)", "19", "21", "5", "FD 46 o", "3" ],
	...
	[ "LD C,(HL)", "7", "8", "2", "4E", "1" ],
	[ "LD C,(IX)", "19", "21", "5", "DD 4E o", "3" ],
	[ "LD C,(IX+o)", "19", "21", "5", "DD 4E o", "3" ],
	[ "LD C,(IY)", "19", "21", "5", "FD 4E o", "3" ],
	...
	[ "LD C,r", "4", "5", "1", "48+r", "1" ],
	[ "LD D,(HL)", "7", "8", "2", "56", "1" ],
	[ "LD D,(IX)", "19", "21", "5", "DD 56 o", "3" ],
	[ "LD D,(IX+o)", "19", "21", "5", "DD 56 o", "3" ],
	[ "LD D,(IY)", "19", "21", "5", "FD 56 o", "3" ],
	...
	[ "LD E,(HL)", "7", "8", "2", "5E", "1" ],
	[ "LD E,(IX)", "19", "21", "5", "DD 5E o", "3" ],
	[ "LD E,(IX+o)", "19", "21", "5", "DD 5E o", "3" ],
	[ "LD E,(IY)", "19", "21", "5", "FD 5E o", "3" ],
	...
	[ "LD E,r", "4", "5", "1", "58+r", "1" ],
	[ "LD H,(HL)", "7", "8", "2", "66", "1" ],
	[ "LD H,(IX)", "19", "21", "5", "DD 66 o", "3" ],
	[ "LD H,(IX+o)", "19", "21", "5", "DD 66 o", "3" ],
	[ "LD H,(IY)", "19", "21", "5", "FD 66 o", "3" ],
	...
	[ "NOP", "4", "5", "1", "0", "1" ],
	[ "OR (HL)", "7", "8", "2", "B6", "1" ],
	[ "OR (IX)", "19", "21", "3", "DD B6 o", "3" ],
	[ "OR (IX+o)", "19", "21", "3", "DD B6 o", "3" ],
	[ "OR (IY)", "19", "21", "3", "FD B6 o", "3" ],
	...
	[ "SBC A,(HL)", "7", "8", "2", "9E", "1" ],
	[ "SBC A,(IX)", "19", "21", "3", "DD 9E o", "3" ],
	[ "SBC A,(IX+o)", "19", "21", "3", "DD 9E o", "3" ],
	[ "SBC A,(IY)", "19", "21", "3", "FD 9E o", "3" ],
	...
	[ "SUB r", "4", "5", "1", "90+r", "1" ],
	[ "XOR (HL)", "7", "8", "2", "AE", "1" ],
	[ "XOR (IX)", "19", "21", "3", "DD AE o", "3" ],
	[ "XOR (IX+o)", "19", "21", "3", "DD AE o", "3" ],
	[ "XOR (IY)", "19", "21", "3", "FD AE o", "3" ],
