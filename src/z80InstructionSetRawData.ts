...
export const z80InstructionSetRawData = [
    [ "ADC A,(HL)", "7", "8", "2", "8E", "1" ],
	[ "ADC A,(IX+o)", "19", "21", "5", "DD 8E o", "3" ],
	[ "ADC A,(IY+o)", "19", "21", "5", "FD 8E o", "3" ],
	...
	[ "ADD A,(HL)", "7", "8", "2", "86", "1" ],
	[ "ADD A,(IX+o)", "19", "21", "5", "DD 86 o", "3" ],
	[ "ADD A,(IY+o)", "19", "21", "5", "FD 86 o", "3" ],
	...
	[ "AND (HL)", "7", "8", "2", "A6", "1" ],
	[ "AND (IX+o)", "19", "21", "5", "DD A6 o", "3" ],
	[ "AND (IY+o)", "19", "21", "5", "FD A6 o", "3" ],
	...
	[ "JP C,nn", "10", "11", "3", "DA nn nn", "3" ],
	[ "JP HL", "4", "5", "1", "E9", "1" ], // alt. JP (HL)
	[ "JP M,nn", "10", "11", "3", "FA nn nn", "3" ],
	[ "JP NC,nn", "10", "11", "3", "D2 nn nn", "3" ],
	[ "JP nn", "10", "11", "3", "C3 nn nn", "3" ],
	[ "JP NZ,nn", "10", "11", "3", "C2 nn nn", "3" ],
	[ "JP P,nn", "10", "11", "3", "F2 nn nn", "3" ],
	[ "JP PE,nn", "10", "11", "3", "EA nn nn", "3" ],
	[ "JP PO,nn", "10", "11", "3", "E2 nn nn", "3" ],
	[ "JP Z,nn", "10", "11", "3", "CA nn nn", "3" ],
	...
	[ "LD D,n", "7", "8", "2", "16 n", "2" ],
	[ "LD D,r", "4", "5", "1", "50+r", "1" ],
	[ "LD DE,(nn)", "20", "22", "6", "ED 5B nn nn", "4" ],
	...
	[ "SBC A,(HL)", "7", "8", "2", "9E", "1" ],
	[ "SBC A,(IX+o)", "19", "21", "5", "DD 9E o", "3" ],
	[ "SBC A,(IY+o)", "19", "21", "5", "FD 9E o", "3" ],
	...
	[ "SUB (HL)", "7", "8", "2", "96", "1" ],
	[ "SUB (IX+o)", "19", "21", "5", "DD 96 o", "3" ],
	[ "SUB (IY+o)", "19", "21", "5", "FD 96 o", "3" ],
